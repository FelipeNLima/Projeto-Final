...
public class frmCategoriaPrincipal extends javax.swing.JFrame {

    public frmCategoriaPrincipal() {
        initComponents();
    ...
    public static void carregarDados(JTable tabela, String descricao) {
        ArrayList<Categoria> lista = Categoria.filtrarPorDescricao(descricao);
    ...
    private void editar() {
        ...
        if (linha >= 0) {
            ...
            Telas.frmCategoria fCategoria = new Telas.frmCategoria(id);
            fCategoria.tabela = tabela;
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        new Telas.frmCategoria().setVisible(true);
        carregarDadosTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCategoriaPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCategoriaPrincipal().setVisible(true);
            }
        });
    }
