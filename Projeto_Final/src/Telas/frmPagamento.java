...
public class frmPagamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            jFormattedTextField1.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("__/__/____")));
        ...
        try {
            jFormattedTextField2.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("__/__/____")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
